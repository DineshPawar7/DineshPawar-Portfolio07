  ...
  return (
    <div className="home-container">
      ...
      <div className="home-content">
        ...
        <h3>Passionate MERN stack developer with expertise in both frontend and backend, crafting scalable and efficient solutions. Experienced in building real-world projects, solving complex challenges, and constantly innovating to create impactful digital experiences.</h3>
